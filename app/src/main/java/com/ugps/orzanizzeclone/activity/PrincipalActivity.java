...
import com.ugps.orzanizzeclone.adapter.AdapterMovimentacao;
...
public class PrincipalActivity extends AppCompatActivity {
    ...
    public void swipe() {
        ...
        ItemTouchHelper.Callback itemTouch = new ItemTouchHelper.Callback() {
            ...
            public int getMovementFlags(@NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder) {
                ...
                int dragFlags  = ItemTouchHelper.ACTION_STATE_IDLE; //isso inativa o drap and drop
                int swipeFlags = ItemTouchHelper.START | ItemTouchHelper.END; //esse permite arrastar do inicio para o final ou vice versa
    ...
    private void excluirMovimentacao(RecyclerView.ViewHolder viewHolder) {
        ...
        alertDialog.setTitle("Exclusão de Movimentação da Conta");
    ...
    public void recuperarResumo(){
        ...
        valueEventListenerUsuario = usuarioRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                DecimalFormat decimalFormat = new DecimalFormat("0.##"); //o sharp ignora o zero para não ficar 800.00 e sim 800
